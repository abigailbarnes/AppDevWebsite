...
task({ :sample_data => :environment}) do
 ...
 claudemonetimage2 = "https://en.wikipedia.org/wiki/File:Water-Lilies-and-Japanese-Bridge-(1897-1899)-Monet.jpg"
 claudemonetimage3 = "https://en.wikipedia.org/wiki/File:Claude_Monet,_Houses_of_Parliament,_London,_1900-1903,_1933.1164,_Art_Institute_of_Chicago.jpg"
 ...
 images = [ claudemonetimage1, claudemonetimage2, claudemonetimage3, henrimattisseimage1, henrimattisseimage2, henrimattisseimage3, vincentvangoghimage1, vincentvangoghimage2, vincentvangoghimage3 ]
 ...
 9.times do |count|
    ...
    painting.artist = artists.at(count)
